package dev.gafilianog.pennydrop.adapters
...
import dev.gafilianog.pennydrop.databinding.PlayerSummaryListItemBinding
...
private class PlayerSummaryDiffCallback : DiffUtil.ItemCallback<PlayerSummary>() {
    override fun areItemsTheSame(oldItem: PlayerSummary, newItem: PlayerSummary):
            Boolean = oldItem.id == newItem.id

    override fun areContentsTheSame(oldItem: PlayerSummary, newItem: PlayerSummary):
