...
import dev.gafilianog.pennydrop.data.*
import dev.gafilianog.pennydrop.game.GameHandler
import dev.gafilianog.pennydrop.game.TurnEnd
import dev.gafilianog.pennydrop.game.TurnResult
...
//                "${ohNoPhrases.shuffled().first()} ${result.previousPlayer?.playerName} rolled a ${result.lastRoll}.  They collected ${result.coinChangeCount} pennies for a total of ${result.previousPlayer?.pennies}.\n$currentText"
